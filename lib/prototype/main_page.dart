...
class _MainPageState extends State<MainPage> {
  ...
  Widget build(BuildContext context) {
    return NotificationListener<ScrollNotification>(
        ...
        child: _MainPageWrapper(scrollOffset: scrollOffset, children: [
              ...
              child: ClipRect(
                  child: Padding(
                      ...
                      child: Row(
                          ...
                          children: const [
                            CategoryIndicator(
                                value: 81, label: "Trees", icon: Icons.park),
                            CategoryIndicator(
                                value: 44, label: "Grasses", icon: Icons.grass),
                            CategoryIndicator(
                                value: 56, label: "Weeds", icon: Icons.spa),
                          ])))),
                  ...
                  child: Card(
                      ...
                      child: Padding(
                          ...
                          child: Row(
                              ...
                              children: [
                                CategoryIndicator(
                                    value: rand.nextInt(100), icon: Icons.park),
                                CategoryIndicator(
                                    value: rand.nextInt(100),
                                    icon: Icons.grass),
                                CategoryIndicator(
                                    value: rand.nextInt(100), icon: Icons.spa),
                              ])))),
              Positioned(
                  left: 20,
                  top: 1,
                  child: Text(day,
                      style: const TextStyle(
                          fontFamily: "Nunito",
                          fontSize: 16,
                          backgroundColor: Color.fromARGB(255, 33, 12, 33))))
            ]))
        .toList();
